...
/**
* @author huangxiao
* @version 创建时间：2018年5月24日 下午2:24:27
* 类说明
*/
public class TestStep extends TestBase{
	 ...
	 * 自定义的步骤、页面
	 **/
	private Class<?> selfAction;
	/**
	 * 自定义的方法
	 **/
	private String selfMethodName;
	
	/**
	 * 自定义方法参数
	 **/
	private Object[] selfMethodParameters;
	...
	public void setAction(String actionName) {
		this.action=new StepAction(actionName);
	}

	public Class<?> getSelfAction() {
		return selfAction;
	}

	public void setSelfAction(String className){
		try {
			this.selfAction = Class.forName(className);
		} catch (ClassNotFoundException e) {
			Assert.fail("selfAction找不到指定类："+className);
		}
	}
	
	public String getSelfMethodName() {
		return selfMethodName;
	}

	public void setSelfMethodName(String selfMethodName) {
		this.selfMethodName = selfMethodName;
	}

	public Object[] getSelfMethodParameters() {
		return selfMethodParameters;
	}

	public void setSelfMethodParameters(Object[] selfMethodParameters) {
		this.selfMethodParameters =  selfMethodParameters;
	}
