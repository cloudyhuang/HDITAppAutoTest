...
public class test {
	public static void main(String[] args) throws Exception {
		...
		getElementLocator("xpath=//android.widget.LinearLayout[@resource-id='com.evergrande.eif.android.hengjiaosuo:id/group_progress']/android.widget.TextView[1]");
		getElementLocator("resource-id=username");
	}
	public static By getElementLocator(String loc) throws Exception{
		   ...
		   String locatevalue = loc.substring(idx1+1,loc.length());
